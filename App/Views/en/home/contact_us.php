<div role="main" class="main">
	<section class="page-header page-header-modern page-header-background page-header-background-md overlay overlay-color-dark overlay-show overlay-op-7" style="background-image: url(/Data/img/contact_us.jpg);">
		<div class="container">
			<div class="row mt-5">
		...
		<div class="row py-4">
				...
				<form id="contactFormAdvanced" action="" method="POST" enctype="multipart/form-data">
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<input type="text" value="" data-msg-required="Your Whatsapp number with country indicator" placeholder="Your Whatsapp number with country indicator" maxlength="100" class="form-control" name="whatsapp" id="whatsapp" required>
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<select data-msg-required="Please enter the subject." class="form-control" name="subject" id="subject" required>
								<option value="">...</option>
								<option value="Option 1">Need a Passport</option>
								<option value="Option 2">Need Driver Licence</option>
								<option value="Option 3">Need ID Card</option>
								<option value="Option 4">Need Resident Permit</option>
								<option value="Option 5">Need Visa</option>
			...
			<div class="col-lg-5">
				...
				<div class="overflow-hidden mb-3">
					<p class="lead text-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">Have you been looking for a passport, SSN, driver’s license, I.D, Birth certificate, diploma or any other document? or maybe to buy passport for Australian or a Canadian document ? is it fake or real passport, SSN, driver’s license, I.D, Birth certificate, diploma or any other document ?</p>
				</div>
				...
				<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
					...
					<ul class="list list-icons list-icons-style-3 mt-2">
						...
						<li><i class="fas fa-phone top-6"></i> <strong>Phone:</strong> +1 (856) 409-0739</li>
						<li><i class="fas fa-envelope top-6"></i> <strong>Email:</strong> <a href="mailto:ashlibrandonetx71@gmail.com">ashlibrandonetx71@gmail.com</a></li>
					</ul>

					<h4 class="text-primary pt-5">Business <strong>Hours</strong></h4>
					<ul class="list list-icons list-dark mt-2">
						<li><i class="far fa-clock top-6"></i> Monday - Sunday - 24h/24</li>
					</ul>
				</div>
